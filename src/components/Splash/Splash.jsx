...
export const Splash = () => {
  ...
  return (
    <div className='splash-container'>
      ...
      <h2>
        <span>Different musical keys can influence our emotions and mental states by evoking specific moods and feelings. 
          ...
          expression and mental well-being</span>
      </h2>
      <Button variant="success" onClick={enterSite}>Enter Here</Button>
    </Container>
    </div>
